export default {
  ...
  household: {
    ...
    avatar: 'Haushalt-Avatar',
    avatarSaved: 'Avatar aktualisiert.',
    avatarFailed: 'Avatar konnte nicht aktualisiert werden.',
  },
  home: {
    greeting: 'Hallo, {{name}}!',
  ...
  todos: {
    ...
    urgentHint: 'Dieses To-Do als dringend / kritisch markieren.',
    markUrgent: '🚩 Als dringend markieren',
    unmarkUrgent: 'Dringend-Markierung aufheben',
    dueWindow: 'Fälligkeitszeitraum',
    dueFrom: 'Fällig ab',
    dueUntil: 'Fällig bis',
    dueFromLabel: 'Ab',
    dueBefore: 'Fällig bis',
    immediately: 'Sofort',
    clearWindow: 'Fälligkeitszeitraum entfernen',
    statusDue: '⏳ Fällig',
    dueBanner: '⏳ Dieses To-Do ist jetzt fällig',
  ...
  calendar: {
    ...
    startDate: 'Beginn',
    endDate: 'Ende',
    endBeforeStart: 'Ende muss nach Beginn liegen.',
    color: 'Farbe',
    visibility: 'Sichtbarkeit',
    visPrivate: 'Privat',
    visHousehold: 'Haushalt',
    visContacts: 'Kontakte',
    visCustom: 'Benutzerdefiniert',
    visibleToHouseholds: 'Sichtbar für Haushalte',
    visibleToPersons: 'Sichtbar für Personen',
    assignTo: 'Zuweisen an',
    createEvent: 'Termin erstellen',
    saveFailed: 'Termin konnte nicht gespeichert werden.',
    deleteTitle: 'Termin löschen',
    deleteMessage: 'Diesen Termin wirklich löschen?',
  ...
  shopping: {
    ...
    manageLabels: 'Kennzeichnungen',
    selectCategory: 'Kategorie wählen',
    noCategory: 'Sonstiges',
    noLabel: 'Sonstiges',
    newCategoryPlaceholder: 'Neue Kategorie...',
    newLabelPlaceholder: 'Neue Kennzeichnung...',
    ...
    deleteLabelTitle: 'Kennzeichnung löschen',
    deleteLabelMessage: 'Kennzeichnung "{{name}}" löschen? Artikel werden zu Sonstiges.',
    bought: 'Gekauft',
    showOlderBought: 'Ältere anzeigen',
    hideOlderBought: 'Ältere ausblenden',
    labelPickerTitle: 'Kennzeichnung wählen',
    addPresets: 'Vorlagen hinzufügen',
    presetsAdded: 'Vorlagen hinzugefügt',
    templates: 'Vorlagen',
    newTemplatePlaceholder: 'Vorlagenname...',
    applyTemplate: 'Zur Liste hinzufügen',
    deleteTemplateTitle: 'Vorlage löschen',
    deleteTemplateMessage: 'Vorlage "{{name}}" wirklich löschen?',
    templateItemPlaceholder: 'Artikelname...',
    emptyTemplate: 'Noch keine Artikel.',
    templateApplied: '{{count}} Artikel hinzugefügt.',
  },
} as const;
