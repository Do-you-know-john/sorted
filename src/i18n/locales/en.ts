export default {
  ...
  todos: {
    ...
    urgentLabel: 'Urgent',
    urgentHint: 'Mark this to-do as urgent / critical.',
    ...
    clearWindow: 'Remove due window',
    statusDue: '⏳ Due now',
    dueBanner: '⏳ This to-do is due now',
    recurring: 'Recurring',
  ...
  calendar: {
    ...
    visPrivate: 'Private',
    visHousehold: 'Household',
    visContacts: 'Contacts',
    visCustom: 'Custom',
    visibleToHouseholds: 'Visible to households',
    visibleToPersons: 'Visible to persons',
    assignTo: 'Assign to',
  ...
  shopping: {
    ...
    deleteLabelMessage: 'Delete label "{{name}}"? Items will be moved to Other.',
    bought: 'Bought',
    showOlderBought: 'Show older',
    hideOlderBought: 'Hide older',
    labelPickerTitle: 'Assign label',
    addPresets: 'Add store presets',
    presetsAdded: 'Store presets added',
    templates: 'Templates',
    newTemplatePlaceholder: 'Template name...',
    applyTemplate: 'Add to list',
    deleteTemplateTitle: 'Delete template',
    deleteTemplateMessage: 'Delete template "{{name}}"?',
    templateItemPlaceholder: 'Item name...',
    emptyTemplate: 'No items yet.',
    templateApplied: '{{count}} item(s) added.',
  },
} as const;
